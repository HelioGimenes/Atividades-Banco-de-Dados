...
CREATE TABLE `empregados` (
  ...
  KEY `fk_projetoss` (`projetos`),
  KEY `fk_departamentos` (`departamento`),
  CONSTRAINT `fk_departamentos` FOREIGN KEY (`departamento`) REFERENCES `departamento` (`id_departamento`),
  CONSTRAINT `fk_projetoss` FOREIGN KEY (`projetos`) REFERENCES `projeto` (`id_projeto`)

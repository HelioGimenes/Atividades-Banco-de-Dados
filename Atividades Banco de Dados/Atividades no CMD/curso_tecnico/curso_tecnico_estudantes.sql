...
--
-- Host: localhost    Database: curso_tecnico
-- ------------------------------------------------------
...
CREATE TABLE `estudantes` (
  ...
  KEY `fk_cursos` (`cursos`),
  CONSTRAINT `fk_cursos` FOREIGN KEY (`cursos`) REFERENCES `cursos` (`id_curso`)
...
-- Dump completed on 2024-10-09 17:03:51

...
--
-- Host: localhost    Database: meus_cds
-- ------------------------------------------------------
...
CREATE TABLE `musicas` (
  ...
  KEY `fk_cantor` (`cantor`),
  KEY `fk_compositor` (`compositor`),
  CONSTRAINT `fk_cantor` FOREIGN KEY (`cantor`) REFERENCES `cantor` (`id_cantor`),
  CONSTRAINT `fk_compositor` FOREIGN KEY (`compositor`) REFERENCES `compositor` (`id_compositor`)
...
-- Dump completed on 2024-10-09 19:27:15

...
CREATE TABLE `exemplares` (
  ...
  KEY `fk_emprestimos` (`emprestimos`),
  CONSTRAINT `fk_emprestimos` FOREIGN KEY (`emprestimos`) REFERENCES `emprestimo` (`id_emprestimo`) ON DELETE CASCADE ON UPDATE CASCADE
